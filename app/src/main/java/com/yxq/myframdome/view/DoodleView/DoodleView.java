package com.yxq.myframdome.view.DoodleView;
...
public class DoodleView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private String savebackgroundColor = "#FFFFFF";
    ...
    public Bitmap getBitmap() {
        ...
        canvas.drawColor(Color.parseColor(savebackgroundColor));
        doDraw(canvas);
        return mBitmap;
    }
    ...
    public String saveBitmap(DoodleView doodleView) {
        String path = AppConfig.STORAGE_HOME_PATH
                + "XHTT/ADB/Sign/" + System.currentTimeMillis() + ".png";
