...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_markerSize, ImageUtils.dpToPx(20, mContext));
        mLineSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_lineSize, ImageUtils.dpToPx(2, mContext));
        ...
        if(mMarker == null) {
            mMarker = mContext.getResources().getDrawable(R.drawable.ic_timelineview_marker);
        }
    ...
    /**
     * Sets ic_timelineview_marker.
     *
     * @param marker will set ic_timelineview_marker drawable to timeline
     */
    ...
    /**
     * Sets ic_timelineview_marker color.
     *
    ...
    /**
     * Sets ic_timelineview_marker size.
     *
     * @param markerSize the ic_timelineview_marker size
     */
